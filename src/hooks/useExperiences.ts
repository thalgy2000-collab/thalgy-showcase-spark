...
const defaultExperiences: Experience[] = [
  {
    ...
    description: "Gestão de funil de vendas de ponta a ponta na Shopee, unindo estratégias de Growth e Customer Experience. Estruturação de testes A/B e implementação de fluxos proativos de retenção.",
    sort_order: 0,
  },
  {
    id: "2",
